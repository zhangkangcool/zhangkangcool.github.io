...
[Typora 使用小技巧（主题、图床等等）108 赞同 · 9 评论文章](https://zhuanlan.zhihu.com/p/163608242)

有人在评论区提到了「语雀」，我也写了一篇文章。和 Typora 相比，语雀具有更强大的在线编辑器，同样也支持 Mermaid 语法进行制图，对各种文档附件支持程度极高。

[「语雀」云笔记到底好用在哪？100 赞同 · 36 评论文章](https://zhuanlan.zhihu.com/p/220504919)
