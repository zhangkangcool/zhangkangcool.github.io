...
ctrl+b %            纵向分隔窗口
ctrl+b ?            显示快捷键帮助
ctrl+b 方向键      上一个及下一个分隔窗口
ctrl+b(按着不放) 方向键     调整分隔窗口大小,
ctrl+b [            滚动，或者 ctrl+b后按pagedown/up,按q退出
ctrl+b ]           粘贴
ctrl+b 空格键       采用下一个内置布局，这个很有意思，在多屏时，用这个就会将多有屏幕竖着展示
ctrl+b z            当前窗口最大化，再次按该快捷键后恢复正常  
