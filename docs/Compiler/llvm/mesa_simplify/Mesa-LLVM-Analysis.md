...
- [1. 核函数编译器总体设计方案](#1)
- [2. Mesa OpenCL编译器分析](#2-mesa-opencl)
  - [2.1 clover代码结构](#21-clover)
  - [2.2 重要数据结构](#22)
  - [2.3 clover编译OpenCL流程](#23-cloveropencl)
  - [2.4 复用clang处理OpenCL的实现原理](#24-clangopencl)
    - [2.4.1 关键字的识别](#241)
    - [2.4.2 内建函数的处理](#242)
  - [2.5 mesa在商卡上运行clover注意事项](#25-mesaclover)
- [3. LLVM代码分析](#3-llvm)
  - [3.1 LLVM代码结构](#31-llvm)
  - [3.2 LLVM 前端](#32-llvm)
    - [3.2.1 clang功能模块](#321-clang)
    - [3.2.2 clang 两种模式](#322-clang)
      - [3.2.2.1 clang driver模式](#3221-clang-driver)
      - [3.2.2.2 clang lib模式](#3222-clang-lib)
    - [3.2.3 核心数据结构](#323)
    ...
    - [3.2.4 clang AST](#324-clang-ast)
      - [3.2.4.1 AST的基本结构](#3241-ast)
      - [3.2.4.2 AST的生成](#3242-ast)
        - [预处理](#_1)
        - [词法分析](#_2)
        - [语法分析](#_3)
        - [语义分析](#_4)
        - [代码生成](#_5)
      - [3.2.4.3 AST的遍历](#3243-ast)
      - [3.2.4.4 AST序列化](#3244-ast)
      - [3.2.4.5 ASTConsumer](#3245-astconsumer)
  - [3.3 LLVM后端](#33-llvm)
    - [3.3.1 LLVM后端基本流程](#331-llvm)
    - [3.3.2 自定义后端实现](#332)
    - [3.3.3 LLVM IR优化](#333-llvm-ir)
      - [3.3.3.1 LLVM Pass及常用子类](#3331-llvm-pass)
      - [3.3.3.2 Pass管理器（Pass Manager)](#3332-passpass-manager)
- [4. 当前实现的OpenCL前端demo代码](#4-opencldemo)
